  ...
  return (
    <div className="flex flex-row justify-evenly max-w-[1080px] mx-auto px-4 min-h-screen shadow-lg bg-slate-800 text-center">
        <div className="pt-32">
            ...
            As I continue my academic journey, I envisions a future where technology and literature converge, creating innovative solutions and enriching human experiences. My dedication to both fields promises a bright future filled with groundbreaking discoveries and captivating narratives.</p>
        </div>
        <div className="pt-32">
